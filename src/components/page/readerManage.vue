    ...
    <div>
        ...
        <el-card class="box-card">
         ...
         <!--   <el-table-column label="状态">
          ...
          <!--  <el-table-column label="可借天数" prop="lendNum"></el-table-column> -->
            <el-table-column label="最多可借书籍" prop="maxNum"></el-table-column>
        ...
        <el-dialog title="添加用户" :visible.sync="addDialogVisible" width="50%" @close="addDialogClosed">
          ...
          <el-form :model="addForm" :rules="rules" ref="addFormRef" label-width="70px">
            ...
            <!-- <el-form-item label="可借天数" prop="lendNum">
              <el-input v-model="addForm.lendNum" type="number"></el-input>
            </el-form-item> -->
            <el-form-item label="最多可借书籍" prop="maxNum">
        ...
        <el-dialog title="修改用户信息" :visible.sync="editDialogVisible" width="50%" @close="editDialogClosed">
          ...
          <!--  <el-form-item label="可借天数" prop="lendNum">
              <el-input v-model="editForm.lendNum" type="number"></el-input>
            </el-form-item> -->
            <el-form-item label="最多可借书籍" prop="maxNum">
...
export default {
  data () {
    ...
    return {
      ...
      /*  lendNum: [
        ...
        maxNum: [
          { required: true, message: '请输入最多可借书籍', trigger: 'blur' },
          {  trigger: 'blur' }
        ]
      },
      // 控制修改用户对话框的显示和隐藏
  ...
  methods: {
     getUserList() {
        ...
        this.$axios.post(url,{keyword: this.queryInfo.query,roleId:this.userInfo.roleId,pageNum:this.queryInfo.pageNum,pageSize:this.queryInfo.pageSize }
        ).then(res =>{
          if(res.data.code ==='0'){
    ...
    removeUserById(id) {
      ...
      this.$confirm("此操作将永久删除该用户, 是否继续?","提示",{
             ...
             var url = '/api/users/deleteUserInfo'
              alert(url)
              this.$axios.post(url,{id:id}
              ).then(res =>{
                if(res.data.code ==='0'){
